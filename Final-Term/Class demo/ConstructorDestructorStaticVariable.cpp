...
public:
    ...
    ~Student(){
        ...
        cout<< studentCount--<<"Number of Student left : "<< studentCount <<endl;
    }
...
int main(){
    ...
    cout<<"Total Student : "<<s1.studentCount<<endl;
    cout<<"Total Student : "<<s2.studentCount<<endl;
    cout<<"Total Student : "<<s3.studentCount<<endl;
    cout<<"Total Student : "<<s1.getStudentCount()<<endl;
    cout<<"Total Student : "<<Student::studentCount<<endl;
